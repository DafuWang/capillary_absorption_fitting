...
%  k1=0.01612;hc1_k1=2.81;hc1=0.0441;%kk1越小上的越快，hcc1_kk1越小上的越慢
 k1=0.0129;hc1=0.0443;hc1_k1=hc1/k1;%hcc1_kk1=hcc1/kk1;%kk1越小上的越快，hcc1_kk1越小上的越慢
...
hold on
plot(F1(:,1),F1(:,2),'k-','linewidth',2);%拟合数据
% hold on
...
hold on
plot(N(:,1),N(:,2),'g*','linewidth',1);%数值解
%% 设定图例，坐标
